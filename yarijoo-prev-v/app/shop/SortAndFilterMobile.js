...
const SortAndFilterMobile = ({ categories }) => {
  ...
  const name = {
    ...
    oldest: "قدیمی تــرین",
    lowest_price: "ارزان تــرین",
    highest_price: "گـــران تــرین",
  };

  const sorts = [
    { name: "جـــدید تــرین", query: "newest" },
    { name: "قدیمی تــرین", query: "oldest" },
    { name: "ارزان تــرین", query: "lowest_price" },
    { name: "گـــران تــرین", query: "highest_price" },
  ];
