...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("mmpi2");
  ...
  "معمولاً خوشحال هستم",
  "گاهی عصبانی می‌شوم",
  "قوانین را رعایت می‌کنم",
  "علاقه زیادی دارم",
  "مردم به من نگاه می‌کنند",
  "نگران‌های زیادی دارم",
  "تجربیات غیرعادی داشته‌ام",
  "پرانرژی هستم",
  "از مهمانی‌ها اجتناب می‌کنم"
        ]
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست MMPI2</h1>
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">تست MMPI2</h1>
