...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("crownemarlowe");
  ...
  const questions = [
  "همیشه آماده پذیرفتن اشتباهاتم هستم",
  "گاهی سعی می‌کنم به جای بخشیدن، انتقام بگیرم",
  "همیشه با مردم مؤدب هستم حتی با افراد ناخوشایند",
  "هرگز از حسادت به خوشبختی دیگران رنج نبرده‌ام",
  "گاهی به جای انجام کار، به آن فکر می‌کنم",
  "هرگز عمداً چیزی نگفتم که احساسات کسی را جریحه‌دار کند",
  "گاهی عصبانی می‌شوم وقتی کاری به میلم نیست",
  "هرگز سوءاستفاده از کسی نکرده‌ام",
  "همیشه قوانین را رعایت می‌کنم حتی وقتی کسی نمی‌بیند",
  "گاهی حرص می‌خورم وقتی کاری به میلم نیست",
  "هرگز دروغ نگفته‌ام",
  "همیشه می‌گویم لطفاً و متشکرم",
  "گاهی از انجام کاری که می‌دانم درست است طفره می‌روم"
        ]
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست CROWNEMARLOWE</h1>
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">تست CROWNEMARLOWE</h1>
