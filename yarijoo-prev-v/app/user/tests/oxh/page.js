...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("oxh");
  ...
  const questions = useMemo(() => [
    "رابطه‌ام کاملاً شاد و موفق است",
    "شریکم بهترین همسر ممکن است",
    "رابطه ما قوی است",
    "تعارضات را خوب حل می‌کنیم",
    "به راحتی با هم صحبت می‌کنیم",
    "به یکدیگر اعتماد داریم",
    "زمان با کیفیت با هم می‌گذرانیم"
  ], []);
  ...
  const getInterpretation = (score) => {
    const maxScore = 35; // 7 questions * 5 points each
    ...
    if (score <= 14) {
      return {
        ...
        details: "نمره پایین شما نشان می‌دهد که رضایت بسیار کمی از رابطه فعلی خود دارید. مشکلات جدی در ارتباط، اعتماد، حل تعارض و صمیمیت وجود دارد که می‌تواند تهدیدکننده رابطه باشد. این وضعیت نیازمند توجه و مداخله حرفه‌ای فوری است.",
        strengths: [
          "آگاهی از مشکل",
          "تمایل به بهبود",
          "جستجوی کمک"
      ...
      return {
        ...
        details: "نمره پایین شما نشان می‌دهد که رضایت کافی از رابطه ندارید. مشکلات قابل توجهی در برخی جنبه‌های رابطه (ارتباط، اعتماد، حل تعارض) وجود دارد که نیاز به تلاش و بهبود دارد. کار بر روی بهبود رابطه ضروری است.",
        strengths: [
  ...
  if (isCompleted) {
    ...
    const chartData = {
      labels: ["نمره شما", "پایین (7-14)", "متوسط (15-21)", "خوب (22-28)", "عالی (29-35)"],
      datasets: [
        {
          label: "OXH Score",
          data: [score, 14, 21, 28, 35],
          backgroundColor: [
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج مقیاس رضایت از رابطه</h1>
                <p className="text-secondaryTextColor">Relationship Satisfaction Scale (OXH)</p>
              </div>
            </div>
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">مقیاس رضایت از رابطه (OXH)</h1>
