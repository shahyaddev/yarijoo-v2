...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("caq");
  ...
  const questions = [
  "معمولاً احساس راحتی می‌کنم",
  "دوست دارم رهبر باشم",
  "ظرفیت کاری زیادی دارم",
  "فرد مسئولی هستم",
  "در موقعیت‌های اجتماعی راحت هستم",
  "حس خوبی نسبت به خودم دارم",
  "احساس سلامتی می‌کنم",
  "تحمل زیادی دارم",
  "وضعیت خوبی دارم",
  "مستقل هستم"
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست CAQ</h1>
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">تست CAQ</h1>
