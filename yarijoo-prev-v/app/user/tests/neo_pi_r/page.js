...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("neo_pi_r");
  ...
  "من فردی پرحرف هستم",
  "مردم را بد نمی‌بینم",
  "همه کارها را سازماندهی می‌کنم",
  "اغلب غمگین می‌شوم",
  "تجربیات جدید می‌خواهم",
  "از مهمانی‌ها لذت می‌برم",
  "به دیگران کمک می‌کنم",
  "مسئولیت‌پذیرم",
  "نگران می‌شوم",
  "خلاق هستم"
        ]
  ...
  const getInterpretation = (score) => {
    ...
    if (percentage < 30) {
      ...
      return {
        ...
        details: "بر اساس پاسخ‌های شما، عملکرد شما در این حوزه در حد متوسط است. این نشان‌دهنده نیاز به توجه بیشتر و بهبود است.",
        strengths: [],
        recommendations: [
      ...
      return {
        level: "سطح بالا",
        color: "#f97316",
        desc: "نمره شما در محدوده بالا قرار دارد.",
        details: "بر اساس پاسخ‌های شما، عملکرد شما در این حوزه در سطح بالا است. نیاز به توجه و پیگیری دارد.",
        strengths: [],
        recommendations: [
          "مراجعه به متخصص برای بررسی دقیق‌تر",
          "در نظر گیری برنامه بهبود",
          "حمایت از اطرافیان",
          "پیگیری منظم"
        ]
      };
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست NEO_PI_R</h1>
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">تست NEO_PI_R</h1>
