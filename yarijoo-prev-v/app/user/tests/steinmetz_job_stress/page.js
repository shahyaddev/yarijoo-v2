...
const Page = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("steinmetz_job_stress");
  const [savedScore, setSavedScore] = useState(null);
    ...
    const questions = [
        ...
        "در محل کار احساس فشار زمانی شدید می‌کنم",
        "مشکلات کاری باعث نگرانی مداوم من می‌شود",
        "احساس می‌کنم که کنترل کمی بر کارم دارم",
        "در محل کار احساس خستگی و فرسودگی می‌کنم",
        "مشکلات کاری بر خواب من تأثیر منفی می‌گذارد",
        "احساس می‌کنم که کارم بر زندگی شخصی من تأثیر منفی می‌گذارد",
        "در محل کار احساس اضطراب و نگرانی مداوم می‌کنم",
        ...
        "احساس می‌کنم که کارم بر سلامت روانی من تأثیر منفی می‌گذارد",
        "در محل کار احساس ناامیدی و درماندگی می‌کنم",
        "مشکلات کاری باعث مشکل در خوابیدن می‌شود",
        "احساس می‌کنم که کارم بر اوقات فراغت من تأثیر منفی می‌گذارد",
        "در محل کار احساس فشار برای رقابت با همکاران می‌کنم",
        "مشکلات کاری باعث مشکل در حفظ روابط اجتماعی می‌شود",
        "احساس می‌کنم که کارم بر آینده من تأثیر منفی می‌گذارد"
    ];
                ...
                <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
                    ...
                    <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست استرس شغلی استاینمتز (تخصصی)</h1>
                                <p className="text-secondaryTextColor">ارزیابی تخصصی استرس شغلی شما</p>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <ul className="text-sm text-secondaryTextColor space-y-1">
                                        <li>• احساس فشار مداوم در محل کار</li>
                                        <li>• مشکل در خواب</li>
            ...
            <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
                ...
                <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-primaryTextColor">تست استرس شغلی استاینمتز (تخصصی)</h1>
