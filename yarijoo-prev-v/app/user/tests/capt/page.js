...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("capt");
  ...
  const questions = [
  "توانایی حل مسائل پیچیده دارم",
  "به سرعت یاد می‌گیرم",
  "دوست دارم رهبر باشم",
  "می‌توانم دیگران را تحت تأثیر قرار دهم",
  "از هنر و خلاقیت لذت می‌برم",
  "ایده‌های نو دارم",
  "در ورزش مهارت دارم",
  "هماهنگی بدنی خوبی دارم",
  "با موسیقی ارتباط دارم",
  ...
  const getInterpretation = (score) => {
    ...
    if (score <= 20) {
      return {
        level: "پایین",
        color: "#dc2626",
        desc: "توانایی‌های شناختی شما در سطح پایین است.",
        details: "مهارت‌های شناختی شما نیاز به تقویت دارد. این شامل مهارت‌های حل مسئله، یادگیری، رهبری، هنر و خلاقیت است.",
        strengths: [
          "پتانسیل برای بهبود"
        ],
        recommendations: [
          "تمرین مهارت‌های شناختی",
          "یادگیری مستمر",
          "چالش‌های جدید",
          "تمرین حل مسئله",
          "مشاوره در صورت نیاز"
      ...
      return {
        level: "متوسط",
        color: "#eab308",
        desc: "توانایی‌های شناختی شما در سطح متوسط است.",
        details: "شما برخی مهارت‌های شناختی را دارید، اما می‌توانید آن‌ها را تقویت کنید.",
        strengths: [
          "برخی مهارت‌های پایه",
          "پتانسیل رشد"
        ],
      ...
      return {
        level: "بالا",
        color: "#22c55e",
        desc: "توانایی‌های شناختی شما در سطح بالا است.",
        details: "شما از مهارت‌های شناختی خوبی برخوردارید که شامل حل مسئله، یادگیری، رهبری، خلاقیت و هماهنگی است.",
        strengths: [
          "حل مسئله خوب",
          "یادگیری سریع",
          "مهارت‌های رهبری",
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست توانایی‌های شناختی (CAPT)</h1>
              ...
              <div className="w-full h-80">
                <Bar data={chartData} options={{
                  ...
                  plugins: {
                    ...
                    title: { display: true, text: 'تحلیل نمره توانایی‌های شناختی', color: '#e5e7eb', font: { size: 16 } }
                  },
                  scales: {
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">تست توانایی‌های شناختی (CAPT)</h1>
