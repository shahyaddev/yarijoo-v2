...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("bipolar_symptoms");
  ...
  const questions = [
  "دوره‌هایی با انرژی بسیار بالا دارم",
  "خواب کمتری نیاز دارم اما خسته نیستم",
  "افکار سریع و پرشی دارم",
  "خیلی زیاد حرف می‌زنم",
  "احساس می‌کنم می‌توانم هر کاری انجام دهم",
  "تصمیمات احمقانه و ریسکی می‌گیرم",
  "بسیار تحریک‌پذیر هستم",
  "پروژه‌های زیاد شروع می‌کنم",
  "احساس بی‌نیازی به خواب دارم",
  "خرج بیش از حد می‌کنم",
  "دوره‌هایی با افسردگی شدید دارم",
  "انرژی بسیار کم دارم",
  "خیلی زیاد می‌خوابم",
  "از همه چیز لذت نمی‌برم",
  "ناامید و یأس دارم",
  "خودکشی به ذهنم می‌رسد",
  "نوسانات شدید خلقی دارم",
  "خلقم به سرعت تغییر می‌کند"
        ]
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست BIPOLAR_SYMPTOMS</h1>
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">تست BIPOLAR_SYMPTOMS</h1>
