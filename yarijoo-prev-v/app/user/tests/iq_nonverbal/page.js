...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("iq_nonverbal");
  ...
  const questions = [
  "کدام شکل ادامه الگو است؟ ○ △ □ ○ △ ?",
  "کدام شکل متفاوت است؟",
  "آینه این شکل ◢ چیست؟",
  "چند مربع در این شکل است؟ ▢▢",
  "کدام شکل را می‌توان چرخاند تا مانند این شود؟ ▲",
  "ادامه: 1, 4, 9, 16, ?",
  "کدام قطعه جا می‌افتد؟",
  "الگوی بعدی: □ ■ □ ■ □ ?",
  "تقارن: اگر | را در وسط بگذاریم، کدام شکل تقارن دارد؟",
  "چند مثلث؟ △△△"
        ]
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست IQ_NONVERBAL</h1>
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">تست IQ_NONVERBAL</h1>
