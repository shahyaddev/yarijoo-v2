...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("borderline_personality");
  ...
  const questions = [
  "به شدت از رها شدن می‌ترسم",
  "روابطم شدید اما ناپایدار است",
  "احساس پوچی دارم",
  "نمی‌دانم واقعاً چه کسی هستم",
  "رفتارهای تکانشی و خطرناک دارم",
  "به خود آسیب می‌زنم",
  "خلق من به سرعت تغییر می‌کند",
  "احساس خلأ و پوچی مزمن دارم",
  "خشم شدید و کنترل‌نشده دارم",
  "در استرس، حالت پارانویا یا جدایی از واقعیت دارم",
  "بین دوست داشتن و متنفر بودن نوسان دارم",
  "ترس از تنهایی شدید دارم",
  "تصویر خودم مدام عوض می‌شود",
  "پرخوری، مصرف مواد یا رفتارهای پرخطر دارم",
  "تهدید به خودکشی می‌کنم",
  "نمی‌توانم تنها باشم",
  "احساسات شدید و متناقض دارم",
  "روابطم آشفته است"
        ]
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست BORDERLINE_PERSONALITY</h1>
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">تست BORDERLINE_PERSONALITY</h1>
