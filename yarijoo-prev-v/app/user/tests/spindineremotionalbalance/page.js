...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("spindineremotionalbalance");
  ...
  const questions = [
  "من معمولاً احساس شادی و رضایت می‌کنم",
  "وقتی مشکلی پیش می‌آید، به راحتی ناراحت می‌شوم",
  "من اغلب احساس امیدواری و خوشبینی دارم",
  "در موقعیت‌های استرس‌زا به راحتی مضطرب می‌شوم",
  "من معمولاً احساس آرامش و تعادل دارم",
  "وقتی کسی مرا ناراحت می‌کند، مدت زیادی عصبانی می‌مانم",
  "من اغلب احساس قدردانی و شکرگزاری می‌کنم",
  "در مواجهه با تغییرات، احساس ترس و نگرانی می‌کنم",
  "من معمولاً احساس اعتماد به نفس و اطمینان دارم",
  "وقتی کارها طبق برنامه پیش نمی‌رود، به راحتی ناامید می‌شوم",
  "من اغلب احساس رضایت از زندگی دارم",
  "در روابط با دیگران، اغلب احساس ناامنی می‌کنم",
  "من معمولاً احساس انرژی و انگیزه دارم",
  "وقتی کسی از من انتقاد می‌کند، به راحتی ناراحت می‌شوم",
  "من اغلب احساس شادی و خوشحالی می‌کنم",
  "در موقعیت‌های جدید، احساس اضطراب و نگرانی می‌کنم",
  "من معمولاً احساس صلح و آرامش درونی دارم",
  "وقتی مشکلی پیش می‌آید، به راحتی احساس درماندگی می‌کنم",
  "من اغلب احساس قدردانی از چیزهای خوب زندگی می‌کنم",
  "در روابط عاطفی، اغلب احساس ناامنی و ترس می‌کنم",
  "من معمولاً احساس رضایت از خودم دارم",
  "وقتی کسی مرا رد می‌کند، به راحتی احساس بی‌ارزشی می‌کنم",
  "من اغلب احساس امید و خوشبینی نسبت به آینده دارم",
  "در موقعیت‌های اجتماعی، اغلب احساس نگرانی و اضطراب می‌کنم",
  "من معمولاً احساس تعادل و هماهنگی درونی دارم"
        ]
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست SPINDINEREMOTIONALBALANCE</h1>
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">تست SPINDINEREMOTIONALBALANCE</h1>
