...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("abs");
  ...
  const questions = [
  "می‌تواند احساسات را بیان کند",
  "می‌تواند دستورات ساده را دنبال کند",
  "می‌تواند لباس‌هایش را تمیز کند",
  "می‌تواند از دستشویی استفاده کند",
  "می‌تواند غذا بخورد بدون کمک",
  "می‌تواند با دیگران بازی کند",
  "می‌تواند نوبت خود را صبر کند",
  "می‌تواند با تغییرات کنار بیاید",
  "می‌تواند مسئولیت‌های ساده انجام دهد",
  "می‌تواند راه برود بدون کمک"
];

  const options = [
  {
    "label": "هرگز یا تقریباً هرگز",
    "value": 0
  },
  {
    "label": "گاهی",
  ...
  const getInterpretation = (score) => {
    ...
    if (percentage < 30) {
      return {
        level: "سطح پایین",
        color: "#22c55e",
        desc: "نمره شما نشان می‌دهد که در این زمینه وضعیت خوبی دارید.",
        details: "بر اساس پاسخ‌های شما، عملکرد مناسبی دارید. این نشانه‌ای از سلامت روانی خوب است.",
        strengths: ["عملکرد مناسب", "سلامت روانی خوب", "توانایی مقابله با چالش‌ها"],
        recommendations: ["ادامه شیوه زندگی فعلی", "حفظ تعادل کار و زندگی", "مراقبت منظم از سلامت"]
      };
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">مقیاس رفتار تطبیقی</h1>
