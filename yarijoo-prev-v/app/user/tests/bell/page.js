...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("bell");
  ...
  const questions = [
  "تنظیم خلق و خو برایم آسان است",
  "معمولاً با مردم خوب کنار می‌آیم",
  "در خانه احساس راحتی می‌کنم",
  "خانواده‌ام از من حمایت می‌کند",
  "از سلامتی خوبی برخوردارم",
  "به ندرت بیمار می‌شوم",
  "در ارتباط با جنس مخالف راحت هستم",
  "در موقعیت‌های اجتماعی مودب هستم",
  "احساساتم را کنترل می‌کنم",
  "تحت فشار آرام می‌مانم"
        ]
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست BELL</h1>
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">تست BELL</h1>
