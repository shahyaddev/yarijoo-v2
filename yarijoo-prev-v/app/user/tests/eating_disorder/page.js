...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("eating_disorder");
  ...
  const questions = [
  "وحشت از اضافه وزن دارم",
  "از چاق بودن اجتناب می‌کنم",
  "فکر می‌کنم چاق هستم",
  "وزنم بر احساسم تأثیر می‌گذارد",
  "پرخوری می‌کنم و کنترل ندارم",
  "غذا می‌خورم تا استفراغ کنم",
  "نگران کالری غذا هستم",
  "از غذاهای نشاسته‌دار اجتناب می‌کنم",
  "احساس می‌کنم دیگران ترجیح می‌دهند چاق‌تر باشم",
  "درباره غذا خوردن فکر می‌کنم",
  "کالری‌ها را می‌سوزانم",
  "دیگران فکر می‌کنند خیلی لاغرم",
  "نگران چربی در بدنم هستم",
  "غذا خوردن بیش از دیگران طول می‌کشد",
  "از غذاهای شیرین اجتناب می‌کنم",
  "رژیم می‌گیرم",
  "دوست دارم معده‌ام خالی باشد",
  "غذاهای جدید امتحان کردن دشوار است",
  "احساس فشار برای لاغر شدن دارم",
  "بعد از غذا احساس گناه می‌کنم",
  "نگران کنترل وزنم هستم",
  "از ملین یا دیورتیک استفاده می‌کنم",
  "احساس می‌کنم باید غذا خوردنم را کنترل کنم",
  "دیگران مرا مجبور به غذا خوردن می‌کنند",
  "وقت زیادی صرف فکر کردن به غذا می‌کنم",
  "بعد از خوردن غذاهای شیرین ناراحت می‌شوم"
        ]
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست EATING_DISORDER</h1>
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">تست EATING_DISORDER</h1>
