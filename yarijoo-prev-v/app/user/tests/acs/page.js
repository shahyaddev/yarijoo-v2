...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("acs");
  ...
  const questions = [
  "به دنبال حل مشکل می‌گردم",
  "برنامه‌ریزی می‌کنم",
  "اقدام مستقیم می‌کنم",
  "راه‌حل جایگزین می‌جویم",
  "احساساتم را بیان می‌کنم",
  "از دیگران حمایت می‌خواهم",
  "به دنبال تسکین عاطفی هستم",
  "گریه می‌کنم",
  "از موقعیت فرار می‌کنم",
  "انکار می‌کنم",
  "به چیز دیگری فکر می‌کنم",
  "مواد یا الکل مصرف می‌کنم",
  "مشکل را از زاویه دیگر می‌بینم",
  "معنای مثبت پیدا می‌کنم",
  "پذیرش می‌کنم"
];
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">مقیاس ACS</h1>
