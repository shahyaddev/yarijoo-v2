...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("mmpi");
  ...
  const questions = [
  "دوست دارم مجلات مکانیک بخوانم",
  "خواب خوبی دارم",
  "آگهی‌ها را دوست دارم",
  "اغلب نگران هستم",
  "گاهی احساس می‌کنم کسی دنبالم است",
  "خانواده‌ام دوستم دارند",
  "گاهی احساسات را کنترل نمی‌کنم",
  "به سلامتی‌ام نگران هستم",
  "مردم درک نمی‌کنند",
  "کارها را تا آخر انجام می‌دهم"
        ]
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست MMPI</h1>
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">تست MMPI</h1>
