...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("aaq2");
  ...
  const questions = [
  "احساسات ناراحت‌کننده مرا از انجام آنچه برایم مهم است بازمی‌دارد.",
  "وقتی افکار منفی دارم، نمی‌توانم روی کارها تمرکز کنم.",
  "برای رهایی از احساسات ناخوشایند خیلی تلاش می‌کنم—even اگر به ضررم باشد.",
  "وقتی حالِ بدی دارم، از موقعیت‌ها/افراد مهم اجتناب می‌کنم.",
  "افکار/احساساتم تعیین می‌کنند که چه کار کنم.",
  "وقتی پریشانم، از ارزش‌ها و اهدافم دور می‌شوم.",
  "برای کنترل کامل افکار و احساساتم تلاش می‌کنم."
        ]

  const options = [
  {
    "value": 1,
    "label": "هرگز درست نیست"
  },
  {
    "value": 2,
    "label": "به‌ندرت درست است"
  },
  {
    "value": 3,
    "label": "گاهی درست است"
  ...
  {
    "value": 6,
    "label": "بیشترِ اوقات درست است"
  },
  {
    "value": 7,
    "label": "همیشه درست است"
  }
        ]
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست AAQ2</h1>
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">تست AAQ2</h1>
