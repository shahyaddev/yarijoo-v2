...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("dark_triad");
  ...
  const questions = [
  "تمایل دارم خودم را تحسین کنم",
  "توجه مرکز را دوست دارم",
  "شایسته احترام ویژه هستم",
  "از دیگران برتر هستم",
  "از دیگران برای اهدافم استفاده می‌کنم",
  "برای پیشرفت از چاپلوسی استفاده می‌کنم",
  "برای رسیدن به هدف از هر روشی استفاده می‌کنم",
  "دیگران را دستکاری می‌کنم",
  "به احساسات دیگران بی‌توجه هستم",
  "همدلی کمی دارم",
  "مردم را سرد می‌دانند",
  "به احساسات خود کنترل ندارم",
  "دوست دارم مورد تحسین باشم",
  "راه‌های فریب دیگران را می‌دانم",
  "پشیمانی کمی احساس می‌کنم",
  "خواهان توجه هستم",
  "برای منافع شخصی دروغ می‌گویم",
  "به دردهای دیگران بی‌تفاوت هستم"
        ]
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست DARK_TRIAD</h1>
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">تست DARK_TRIAD</h1>
