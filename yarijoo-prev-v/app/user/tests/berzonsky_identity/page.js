...
const TestPage = () => {
  const { previousResult, loading: resultLoading, saveResult, resetResult, hasResult } = useTestResult("berzonsky_identity");
  ...
  const questions = [
  "فعالانه به دنبال کشف خودم می‌گردم",
  "می‌دانم چه کسی هستم",
  "ارزش‌های خانواده را پذیرفته‌ام",
  "از مسیری که دیگران برایم تعیین کردند پیروی می‌کنم",
  "درباره هویتم فکر نمی‌کنم",
  "هرچه پیش آید قبول می‌کنم",
  "در جستجوی هویتم هستم",
  "هنوز نمی‌دانم چه کسی هستم",
  "اهداف روشنی دارم",
  "باورهای محکمی دارم"
        ]
        ...
        <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
          ...
          <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-primaryTextColor">نتایج تست BERZONSKY_IDENTITY</h1>
      ...
      <div className="w-full max-w-[1280px] flex flex-col md:flex-row gap-4 mt-4 lg:mt-24 px-4">
        ...
        <div className="w-full flex flex-col gap-6 h-auto bg-secondaryThemeColor rounded-2xl p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primaryTextColor">تست BERZONSKY_IDENTITY</h1>
