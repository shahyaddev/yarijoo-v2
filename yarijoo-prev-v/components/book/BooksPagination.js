...
const BooksPagination = ({ currentPage, totalPages, totalBooks, perPage = 12 }) => {
  ...
  return (
    <div className="w-full flex flex-col items-center gap-4 mt-8">
      <div className="text-sm text-secondaryTextColor">
        نمایش {toFarsiNumber((currentPage - 1) * perPage + 1)} تا {toFarsiNumber(Math.min(currentPage * perPage, totalBooks))} از {toFarsiNumber(totalBooks)} کتاب
      </div>
